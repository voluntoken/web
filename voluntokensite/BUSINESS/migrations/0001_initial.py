# Generated by Django 2.1.7 on 2019-03-10 00:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Donation_or_Discount', models.BooleanField(default=True)),
                ('token_cost', models.FloatField(default=0.0)),
                ('donation_val', models.FloatField(default=0.0)),
                ('parent_business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BUSINESS.businesses')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BUSINESS.businesses')),
                ('parent_volunteer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
